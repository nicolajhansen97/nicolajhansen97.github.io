      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4 -mx-4 px-4 scrollbar-hide">
          {testimonials.map((testimonial, i) => (
            <FadeIn key={testimonial.id} delay={i * 0.1} className="snap-center shrink-0 w-[350px] sm:w-[400px]">
              <div className="h-full rounded-xl bg-white/5 backdrop-blur-md border border-white/10 p-6 relative">
                {/* Quote icon */}
                <Quote className="absolute top-4 right-4 text-cyan-400/10" size={48} />
